...
class VSAUpdateParameter {
    Program m_program;

    Set<String> m_setAllScopes;
     ...
     */
    private void updateOnMicrosoftWindows64(Function function) {

    }

    public boolean updateFunctionParameters(Function function, Map<String, List<Long>> possilbe_struct_scope) {
