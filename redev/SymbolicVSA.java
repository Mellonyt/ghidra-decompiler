...
public class SymbolicVSA extends GhidraScript {
    ...
    public void run() {
        ...
        StructInfer infer = new StructInfer();
        ...
        while (iter.hasNext() && !monitor.isCancelled()) {
            ...
            // Entry-point
            // if (f.getEntryPoint().getOffset() != 0x400726)
            //     continue;
            ...
            for (String msg : info) {
                println("Find array: " + msg);
            }
            
            Map<String, List<Long>> mapStruct = infer.inferStruct(scopeAccess);
            for (Map.Entry<String, List<Long>> entmapStruct: mapStruct.entrySet()) {
