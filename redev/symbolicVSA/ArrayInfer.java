...
public class ArrayInfer {
     ...
     * @return
     */
    public Set<Map<String, List<Long>>> findPossibleArrayAccess(Map<Long, Map<String, Set<String>>> symbolic_memory_access_table) {
     ...
     * @return
     */
    public Map<String, List<Long>> findMemoryScopesWOArray(Map<Long, Map<String, Set<String>>> symbolic_memory_access_table) {
     ...
     * @return
     */
    public Set<String> inferArray(Set<Map<String, List<Long>>> possible_array_scope, Map<String, List<Long>> all_memory_scopes) {
